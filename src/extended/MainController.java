...
public class MainController {
	...
	public static final int GROUP_LAYOUT = 0, BUTTON = 1;

	public static final int ACTION_CONTINUE = 0, ACTION_REACTIVAR_PADRE = 1;
	...
	public static Font getDefaultFont(int element) {
		switch (element) {
			...
			case GROUP_LAYOUT :
				return new Font("Tahoma", Font.BOLD | Font.ITALIC, 12);
			case BUTTON :
				return new Font("Tahoma", Font.BOLD | Font.ITALIC, 14);
